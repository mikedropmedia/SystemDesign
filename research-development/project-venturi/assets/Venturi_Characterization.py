...
ptg_names = ['t','Q_ptg']
ptg = pd.read_csv(p2ptgdata,sep=None,header=7,names=ptg_names,index_col=False,engine='python')
...
ax2.grid()
ax2.legend(['1:1 Ideal','Data','y = '+str(round(coefs_pp[1],3))+'x + '+str(round(coefs_pp[0],3))])
...
PTG_fit_label = 'PTG: '+str(round(coefs_ptg[0],4)) + ' + ' + str(round(coefs_ptg[1],4)) + 'x + ' + str(round(coefs_ptg[2],4)) + 'x^2'
AMS_fit_label = 'AMS: '+str(round(coefs_ams[0],4)) + ' + ' + str(round(coefs_ams[1],4)) + 'x + ' + str(round(coefs_ams[2],4)) + 'x^2'
MXP_fit_label = 'MXP: '+str(round(coefs_mxp[0],4)) + ' + ' + str(round(coefs_mxp[1],4)) + 'x + ' + str(round(coefs_mxp[2],4)) + 'x^2'
#ax1.legend((MXPfit,PTGfit),(MXP_fit_label,PTG_fit_label))
ax1.legend(['PTG','AMS','MXP',PTG_fit_label,AMS_fit_label,MXP_fit_label])
...
ax1.grid()
ams_reg_label = 'AMS sensor regression: y = '+str(round(coefs_Qams[1],3))+'x + '+str(round(coefs_Qams[0],3))
mxp_reg_label = 'MXP sensor regression: y = '+str(round(coefs_Qmxp[1],3))+'x + '+str(round(coefs_Qmxp[0],3))
